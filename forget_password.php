...
<body>
    <div class="card bg-dark text-white">
        <div class="card-body p-5 text-center">
            ...
            <p class="text-white-50 mb-5">Enter your email or username linked to your account.</p>

            <form id="find-account-form" method="POST">
                <div class="form-outline form-white mb-4">
                    <label class="form-label" for="emailUsername">Email or Username</label>
                    <input type="text" id="emailUsername" name="emailUsername" class="form-control form-control-lg" required>
                </div>
    ...
    <script>
        $(document).ready(function(){
            $('#find-account-form').on('submit', function(event){
                ...
                const emailUsername = $('#emailUsername').val().trim();
