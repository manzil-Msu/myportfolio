    ...
    <div class="card bg-dark text-white" style="border-radius: 1rem;">
        <div class="card-body p-5 text-center">
            <div class="mb-md-5 mt-md-4 pb-5">
                ...
                <form id="login-form" action="login_check.php" name="login-form" method="POST">
                    <div class="form-outline form-white mb-4">
                        <label class="form-label" for="email">Email</label>
                        <input type="email" id="email" name="email" class="form-control form-control-lg input-dark-mode" required onpaste="return false;" placeholder="Enter your email" />
                    ...
                    <div class="form-outline form-white mb-4 password-toggle">
                        ...
                        <div class="password-input">
                            <input type="password" id="password" name="passwords" class="form-control form-control-lg input-dark-mode" required onpaste="return false;" placeholder="Enter your password"/>
                            <i class="fas fa-eye-slash password-toggle-icon"></i>
                        </div>
                        <div class="invalid-feedback">Please enter a valid password.</div>
                    </div>

                    <div class="g-recaptcha" data-sitekey="6LeaLvMpAAAAANTSC8muNVN4t18R_Z4xdi1aFlXk"></div>

                    <button class="btn btn-outline-light btn-lg px-5" type="submit" name="stmt">Login</button>
                    
                    <div>
                        <p class="mb-0 mt-3"><a href="find_account.php" class="text-white-50 fw-bold">Forgot Password?</a></p>
                    </div>
                    
                    <div>
                        <p class="mb-0 mt-3">Don't have an account? <a href="register.php" class="text-white-50 fw-bold">Sign Up</a></p>
                    </div>
                </form>
            </div>
        </div>
